const projects = {
  ...
  group4: [
    ...
    { name: "项目4-3 Snake Game", description: "这是另一个用JavaScript实现的项目", url: "project4-3/index.html" },
    { name: "项目4-4 Midi Piano", description: "这是另一个用JavaScript实现的项目", url: "project4-4/index.html" },
    // 添加更多项目...
  ],
  group5: [
